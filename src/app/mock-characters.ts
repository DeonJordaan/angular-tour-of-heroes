...
export const CHARACTERS: Character[] = [
    { id: 11, name: 'Windstorm', strength: 10, type: 'hero' },
      ...
      { id: 29, name: 'PhpIsJustAScriptingLanguage', strength: 10, type: 'villian' },
